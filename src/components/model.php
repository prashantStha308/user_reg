...
<div class="absoulte px-4 min-h-screen w-full grid">
    <div class="flex justify-center items-center min-h-full bg-black/5 dark:bg-white/5 backdrop-blur-3xl z-40 shadow-md border border-gray-500 rounded-md overflow-y-hidden p-4 ">
        ...
        <div class="absolute top-5 left-4 -z-30 px-44 py-24 rounded-md bg-purple-500 dark:bg-gray-600/90 blur-3xl" ></div>
    </div>
</div>
